...
int iniciaMemLog(char* nome) {
    ...
    assert(ml.log != nullptr && "Cannot open memlog output");
    ...
    assert(retprint >= 0 && "Nao foi possivel escrever registro");
    return result;
}
...
int finalizaMemLog() {
    ...
    assert(retclose == 0 && "Nao foi possivel fechar o arquivo de registro");
